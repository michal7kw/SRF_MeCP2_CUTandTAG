#!/bin/bash
#SBATCH --job-name=enrichment_NSC_4
...
#SBATCH --error="logs/enrichment_NSC_4.err"
#SBATCH --output="logs/enrichment_NSC_4.out"
...
python -u ../scripts/analyze_enrichment_NSC_4.py \
    ...
    --results-dir /beegfs/scratch/ric.broccoli/kubacki.michal/SRF_CUTandTAG/iterative_alternative/results_4 \
    2>&1 | tee "logs/enrichment_NSC_4.out"


# peaks were copied to results_4 from results_2