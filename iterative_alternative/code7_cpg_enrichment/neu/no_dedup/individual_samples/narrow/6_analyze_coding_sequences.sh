...
#SBATCH --error="logs/cpg_enrichment/nsc/no_dedup/from_individual_samples/analyze_coding_sequences.err"
#SBATCH --output="logs/cpg_enrichment/nsc/no_dedup/from_individual_samples/analyze_coding_sequences.out"
