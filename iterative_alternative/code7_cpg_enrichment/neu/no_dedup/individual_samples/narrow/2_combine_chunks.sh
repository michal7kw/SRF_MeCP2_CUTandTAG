...
#SBATCH --error="logs/cpg_enrichment/nsc/no_dedup/individual_samples/narrow/nsc_combine_chunks.err"
#SBATCH --output="logs/cpg_enrichment/nsc/no_dedup/individual_samples/narrow/nsc_combine_chunks.out"
