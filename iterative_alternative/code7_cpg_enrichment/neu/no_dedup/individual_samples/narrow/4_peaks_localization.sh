...
#SBATCH --error="logs/cpg_enrichment/nsc/no_dedup/individual_samples/narrow/peaks_localization.err"
#SBATCH --output="logs/cpg_enrichment/nsc/no_dedup/individual_samples/narrow/peaks_localization.out"
