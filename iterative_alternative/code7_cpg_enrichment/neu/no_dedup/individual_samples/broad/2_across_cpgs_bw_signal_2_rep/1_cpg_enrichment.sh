...
#SBATCH --error="logs/cpg_enrichment/neu/no_dedup/individual_samples/broad/cpg_enrichment_2_rep_in_cpg.err"
#SBATCH --output="logs/cpg_enrichment/neu/no_dedup/individual_samples/broad/cpg_enrichment_2_rep_in_cpg.out"
