...
#SBATCH --error="logs/cpg_enrichment/nsc/dedup/individual_samples/narrow/split_the_list_with_flanking.err"
#SBATCH --output="logs/cpg_enrichment/nsc/dedup/individual_samples/narrow/split_the_list_with_flanking.out"
