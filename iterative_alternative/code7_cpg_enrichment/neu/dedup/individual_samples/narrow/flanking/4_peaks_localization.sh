...
#SBATCH --error="logs/cpg_enrichment/nsc/dedup/individual_samples/narrow/peaks_localization_with_flanking.err"
#SBATCH --output="logs/cpg_enrichment/nsc/dedup/individual_samples/narrow/peaks_localization_with_flanking.out"
