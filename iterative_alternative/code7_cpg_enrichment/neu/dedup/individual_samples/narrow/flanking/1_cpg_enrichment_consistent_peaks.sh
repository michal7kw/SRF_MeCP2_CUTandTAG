...
#SBATCH --error="logs/cpg_enrichment/nsc/dedup/individual_samples/narrow/cpg_enrichment_consistent_peaks_with_flanking.err"
#SBATCH --output="logs/cpg_enrichment/nsc/dedup/individual_samples/narrow/cpg_enrichment_consistent_peaks_with_flanking.out"
