#!/bin/bash
#SBATCH --job-name=combine_chunks_neu_vs_nsc_exo
...
#SBATCH --error="logs/cpg_enrichment/neu_vs_nsc_exo/combine_chunks_neu_vs_nsc_exo.err"
#SBATCH --output="logs/cpg_enrichment/neu_vs_nsc_exo/combine_chunks_neu_vs_nsc_exo.out"
