...
if [ ! -f "${SCRIPT_DIR}/peaks_localization_neu_vs_nsc_exo.R" ]; then
    echo "Error: R script not found at ${SCRIPT_DIR}/peaks_localization_neu_vs_nsc_exo.R"
    exit 1
fi
...
Rscript "${SCRIPT_DIR}/peaks_localization_neu_vs_nsc_exo.R" \
