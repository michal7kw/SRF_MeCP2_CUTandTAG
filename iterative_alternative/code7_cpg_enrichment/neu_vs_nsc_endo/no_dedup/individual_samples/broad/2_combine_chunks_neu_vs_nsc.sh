#!/bin/bash
#SBATCH --job-name=combine_chunks_neu_vs_nsc_endo
...
#SBATCH --error="logs/cpg_enrichment/neu_vs_nsc_endo/combine_chunks_neu_vs_nsc_endo.err"
#SBATCH --output="logs/cpg_enrichment/neu_vs_nsc_endo/combine_chunks_neu_vs_nsc_endo.out"
