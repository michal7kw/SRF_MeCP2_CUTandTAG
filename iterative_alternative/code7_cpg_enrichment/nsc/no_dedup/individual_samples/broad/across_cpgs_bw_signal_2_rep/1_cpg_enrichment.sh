#!/bin/bash
#SBATCH --job-name=cpg_enrichment_2_rep_in_cpg
...
#SBATCH --error="logs/cpg_enrichment/nsc/no_dedup/individual_samples/broad/cpg_enrichment_2_rep_in_cpg.err"
#SBATCH --output="logs/cpg_enrichment/nsc/no_dedup/individual_samples/broad/cpg_enrichment_2_rep_in_cpg.out"
...
RESULTS_DIR="${PEAKS_BASE_DIR}/cpg_enrichment_2_rep_in_cpg"
...
python ${SCRIPT_DIR}/cpg_enrichment_2_rep_in_cpg.py \
