#!/bin/bash
#SBATCH --job-name=cpg_enrichment_2_rep_with_flanking
...
#SBATCH --error="logs/cpg_enrichment/nsc/no_dedup/individual_samples/broad/cpg_enrichment_2_rep_with_flanking.err"
#SBATCH --output="logs/cpg_enrichment/nsc/no_dedup/individual_samples/broad/cpg_enrichment_2_rep_with_flanking.out"
...
SCRIPT_DIR="${BASE_DIR}/scripts/cpg_enrichment/peaks_signal"
...
# Process chunk
python ${SCRIPT_DIR}/cpg_enrichment_2_rep_with_flanking.py \
