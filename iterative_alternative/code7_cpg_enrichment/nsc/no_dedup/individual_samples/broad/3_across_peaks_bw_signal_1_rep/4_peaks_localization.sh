...
#SBATCH --error="logs/cpg_enrichment/nsc/no_dedup/individual_samples/broad/log_%a.err"
#SBATCH --output="logs/cpg_enrichment/nsc/no_dedup/individual_samples/broad/log_%a.out"
