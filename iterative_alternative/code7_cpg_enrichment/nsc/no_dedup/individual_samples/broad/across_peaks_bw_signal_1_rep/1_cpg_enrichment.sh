#!/bin/bash
#SBATCH --job-name=cpg_enrichment_1_rep_in_peaks
...
#SBATCH --error="logs/cpg_enrichment/nsc/no_dedup/individual_samples/broad/cpg_enrichment_1_rep_in_peaks.err"
#SBATCH --output="logs/cpg_enrichment/nsc/no_dedup/individual_samples/broad/cpg_enrichment_1_rep_in_peaks.out"
...
RESULTS_DIR="${PEAKS_BASE_DIR}/cpg_enrichment_1_rep_in_peaks"
...
echo "Running peak-focused enrichment analysis..."

# Run the Python script with peak directories
python ${SCRIPT_DIR}/cpg_enrichment_1_rep_in_peaks.py \
