...
#SBATCH --error="logs/cpg_enrichment/nsc/no_dedup/individual_samples/broad/cpg_enrichment_consistent_peaks.err"
#SBATCH --output="logs/cpg_enrichment/nsc/no_dedup/individual_samples/broad/cpg_enrichment_consistent_peaks.out"
