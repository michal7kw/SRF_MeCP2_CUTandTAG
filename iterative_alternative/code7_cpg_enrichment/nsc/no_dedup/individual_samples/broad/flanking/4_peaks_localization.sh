...
#SBATCH --error="logs/cpg_enrichment/nsc/no_dedup/individual_samples/broad/peaks_localization.err"
#SBATCH --output="logs/cpg_enrichment/nsc/no_dedup/individual_samples/broad/peaks_localization.out"
