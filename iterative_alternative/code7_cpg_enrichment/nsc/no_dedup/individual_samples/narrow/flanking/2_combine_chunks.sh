#!/bin/bash
#SBATCH --job-name=nsc_combine_chunks_with_flanking
...
#SBATCH --error="logs/cpg_enrichment/nsc/no_dedup/individual_samples/narrow/nsc_combine_chunks_with_flanking.err"
#SBATCH --output="logs/cpg_enrichment/nsc/no_dedup/individual_samples/narrow/nsc_combine_chunks_with_flanking.out"
