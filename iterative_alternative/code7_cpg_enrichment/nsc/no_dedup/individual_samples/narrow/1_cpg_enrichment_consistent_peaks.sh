...
#SBATCH --error="logs/cpg_enrichment/nsc/no_dedup/individual_samples/narrow/cpg_enrichment_consistent_peaks.err"
#SBATCH --output="logs/cpg_enrichment/nsc/no_dedup/individual_samples/narrow/cpg_enrichment_consistent_peaks.out"
