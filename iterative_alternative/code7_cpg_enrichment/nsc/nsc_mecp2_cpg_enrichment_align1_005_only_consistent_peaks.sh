#!/bin/bash
#SBATCH --job-name=nsc_cpg_enrichment_align1_005_consistent_peaks
...
#SBATCH --error="logs/nsc_cpg_enrichment_align1_005_consistent_peaks.err"
#SBATCH --output="logs/nsc_cpg_enrichment_align1_005_consistent_peaks.out"
...
EXPERIMENT_IN="align1_005"
EXPERIMENT_OUT="align1_005_consistent_peaks"
...
# Process chunk
python ../scripts/cpg_enrichment/analyze_mecp2_cpg_enrichment_only_consistent_peaks.py \
...
# consistent peaks from NSC samples
#
# Input files:
# - Exogenous peaks (NSCv1-3) from ${PEAKS_EXPERIMENT}/peaks/narrow/
# - Endogenous peaks (NSCM1-3) from ${PEAKS_EXPERIMENT}/peaks/narrow/
# - CpG islands file (${DATA_DIR}/cpg_islands.bed)
