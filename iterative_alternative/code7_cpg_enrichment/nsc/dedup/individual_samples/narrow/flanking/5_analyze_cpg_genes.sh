...
#SBATCH --error="logs/cpg_enrichment/nsc/dedup/individual_samples/narrow/analyze_cpg_genes_with_flanking.err"
#SBATCH --output="logs/cpg_enrichment/nsc/dedup/individual_samples/narrow/analyze_cpg_genes_with_flanking.out"
