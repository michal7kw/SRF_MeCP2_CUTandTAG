...
#SBATCH --error="logs/cpg_enrichment/nsc/dedup/individual_samples/broad/cpg_enrichment_consistent_peaks_with_flanking.err"
#SBATCH --output="logs/cpg_enrichment/nsc/dedup/individual_samples/broad/cpg_enrichment_consistent_peaks_with_flanking.out"
...
python ${SCRIPT_DIR}/cpg_enrichment_consistent_peaks_with_flanking.py \
    ...
    --output-dir ${RESULTS_DIR}/mecp2_cpg_enrichment_parallel_with_flanking \
...
#
# Input files:
# - Peak files from ${PEAKS_EXPERIMENT}/peaks/broad/
#   - Exogenous (NSCv1-3) and endogenous (NSCM1-3) broad peak files
