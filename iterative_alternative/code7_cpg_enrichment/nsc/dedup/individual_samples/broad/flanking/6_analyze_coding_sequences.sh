...
#SBATCH --error="logs/cpg_enrichment/nsc/dedup/individual_samples/broad/analyze_coding_sequences_with_flanking.err"
#SBATCH --output="logs/cpg_enrichment/nsc/dedup/individual_samples/broad/analyze_coding_sequences_with_flanking.out"
