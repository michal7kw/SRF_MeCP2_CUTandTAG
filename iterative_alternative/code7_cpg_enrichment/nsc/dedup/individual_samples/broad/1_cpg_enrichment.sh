#!/bin/bash
#SBATCH --job-name=nsc_cpg_enrichment_align2_005
...
#SBATCH --error="logs/nsc_cpg_enrichment_align2_005.err"
#SBATCH --output="logs/nsc_cpg_enrichment_align2_005.out"
...
# Process chunk
python ../scripts/cpg_enrichment/analyze_mecp2_cpg_enrichment.py \
