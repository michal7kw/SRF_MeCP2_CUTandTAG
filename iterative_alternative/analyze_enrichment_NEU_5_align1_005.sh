#!/bin/bash
#SBATCH --job-name=enrichment_NEU_5_new_005
...
#SBATCH --error="logs/enrichment_NEU_5_new_005.err"
#SBATCH --output="logs/enrichment_NEU_5_new_005.out"
...
python -u ../scripts/analyze_enrichment_NEU_5.py \
    ...
    2>&1 | tee "logs/enrichment_NEU_5_new_005.out"