#!/bin/bash
#SBATCH --job-name=enrichment_NEU_5_align1_005
...
#SBATCH --error="logs/enrichment_NEU_5_align1_005.err"
#SBATCH --output="logs/enrichment_NEU_5_align1_005.out"
...
RESULTS_DIR="/beegfs/scratch/ric.broccoli/kubacki.michal/SRF_CUTandTAG/iterative_alternative/results_5_align1_005"
...
for sample in NeuM2 NeuM3 NeuV1 NeuV2 NeuV3; do
...
python -u ../scripts/analyze_enrichment_NEU_5.py \
    --working-dir $WORKING_DIR \
    --data-dir $DATA_DIR \
    --results-dir $RESULTS_DIR \
    2>&1 | tee "logs/enrichment_NEU_5_align1_005.out"