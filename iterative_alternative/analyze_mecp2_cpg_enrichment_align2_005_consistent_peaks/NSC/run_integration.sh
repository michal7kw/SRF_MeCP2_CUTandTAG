#!/bin/bash
#SBATCH --job-name=analyze_cpg_integrationy
...
#SBATCH --error="logs/analyze_mecp2_cpg_integration.err"
#SBATCH --output="logs/analyze_mecp2_cpg_integration.out"
...
python ${SCRIPT_DIR}/analyze_cpg_integration_only_consistent_peaks.py "$EXPERIMENT" "$CELL_LINE"
