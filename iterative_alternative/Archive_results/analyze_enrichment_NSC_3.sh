#!/bin/bash
#SBATCH --job-name=enrichment_NSC_3
...
#SBATCH --error="logs/enrichment_NSC_3.err"
#SBATCH --output="logs/enrichment_NSC_3.out"
...
python -u ../scripts/analyze_enrichment_NSC_3.py \
    ...
    --results-dir /beegfs/scratch/ric.broccoli/kubacki.michal/SRF_CUTandTAG/iterative_alternative/results_3 \
    2>&1 | tee "logs/enrichment_NSC_3.out"

# peaks were copied to results_3 from results_2