#!/bin/bash
#SBATCH --job-name=nsc_cpg_enrichment_align1_original
...
#SBATCH --error="logs/nsc_cpg_enrichment_align1_original.err"
#SBATCH --output="logs/nsc_cpg_enrichment_align1_original.out"
