#!/bin/bash
#SBATCH --job-name=align1_peaks_new_005
...
#SBATCH --error="logs/peaks_new_005_align1.err"
#SBATCH --output="logs/peaks_new_005_align1.out"
...
BLACKLIST="/beegfs/scratch/ric.broccoli/kubacki.michal/SRF_MeCP2_CUTandTAG/DATA/mm10-blacklist.bed"
