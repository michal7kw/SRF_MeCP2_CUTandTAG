#!/bin/bash
#SBATCH --job-name=enrichment_NSC_1
...
#SBATCH --error="logs/enrichment_NSC_1.err"
#SBATCH --output="logs/enrichment_NSC_1.out"
...
python -u ../scripts/analyze_enrichment_NSC.py \
    ...
    --results-dir /beegfs/scratch/ric.broccoli/kubacki.michal/SRF_CUTandTAG/iterative_alternative/results_1 \
    2>&1 | tee "logs/enrichment_NSC_1.out"
