#!/bin/bash
#SBATCH --job-name=nsc_cpg_enrichment_align1_seacr
...
#SBATCH --error="logs/nsc_cpg_enrichment_align1_seacr.err"
#SBATCH --output="logs/nsc_cpg_enrichment_align1_seacr.out"
