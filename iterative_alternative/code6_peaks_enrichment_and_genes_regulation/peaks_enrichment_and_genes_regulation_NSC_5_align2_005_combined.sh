#!/bin/bash
#SBATCH --job-name=peaks_enrichment_and_genes_regulation_NSC_5_combined
...
#SBATCH --error="logs/peaks_enrichment_and_genes_regulation_NSC_5_combined.err"
#SBATCH --output="logs/peaks_enrichment_and_genes_regulation_NSC_5_combined.out"
...
RESULTS_DIR="${WORKING_DIR}/results_5_align2_005/peaks_enrichment_and_genes_regulation_NSC_5_combined"
