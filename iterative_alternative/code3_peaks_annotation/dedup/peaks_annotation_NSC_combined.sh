#!/bin/bash
#SBATCH --job-name=pa_dedup_NSC_combined
...
#SBATCH --error="logs/peaks_annotation/dedup/peaks_annotation_NSC_combined.err"
#SBATCH --output="logs/peaks_annotation/dedup/peaks_annotation_NSC_combined.out"
...
for PEAK_TYPE in narrow broad; do
    ...
    Rscript "${SCRIPT_DIR}/peaks_annotation_NSC_combined.R" \
        ...
        --peak-type "${PEAK_TYPE}" \
        2>&1 | tee "logs/peaks_annotation/dedup/peaks_annotation_NSC_combined_${PEAK_TYPE}.out"
done
