#!/bin/bash
#SBATCH --job-name=nsc_integrate_align2_005
...
#SBATCH --error="logs/nsc_integrate_align2_005.err"
#SBATCH --output="logs/nsc_integrate_align2_005.out"
...
python ../scripts/cpg_enrichment_integration/integrate_rna_seq.py \
