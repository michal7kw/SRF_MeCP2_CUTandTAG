#!/bin/bash
#SBATCH --job-name=enrichment_NSC_5_align1_001
...
#SBATCH --error="logs/enrichment_NSC_5_align1_001.err"
#SBATCH --output="logs/enrichment_NSC_5_align1_001.out"
...
INPUT_DIR="/beegfs/scratch/ric.broccoli/kubacki.michal/SRF_CUTandTAG/iterative_alternative/results_2_align1_001"
RESULTS_DIR="/beegfs/scratch/ric.broccoli/kubacki.michal/SRF_CUTandTAG/iterative_alternative/results_5_align1_001"


echo "Copying and renaming peaks from results_2_align1_001 to ${RESULTS_DIR}..."
...
python -u ../scripts/analyze_enrichment_NSC_5.py \
    ...
    2>&1 | tee "logs/enrichment_NSC_5_align1_001.out"