#!/bin/bash
#SBATCH --job-name=enrichment_NSC_5_new_001
...
#SBATCH --error="logs/enrichment_NSC_5_new_001.err"
#SBATCH --output="logs/enrichment_NSC_5_new_001.out"
...
RESULTS_DIR="/beegfs/scratch/ric.broccoli/kubacki.michal/SRF_CUTandTAG/iterative_alternative/results_5_new_001"


# Fix the copying and renaming of peak files
echo "Copying and renaming peaks from results_2_new_001 to ${RESULTS_DIR}..."
rm -rf "${RESULTS_DIR}/peaks"
mkdir -p "${RESULTS_DIR}/peaks"

# Copy and rename files
for sample in NSCv1 NSCv2 NSCv3 NSCM1 NSCM2 NSCM3; do
    if [ -f "/beegfs/scratch/ric.broccoli/kubacki.michal/SRF_CUTandTAG/iterative_alternative/results_2_new_001/peaks/narrow/${sample}_narrow_peaks.narrowPeak" ]; then
        cp "/beegfs/scratch/ric.broccoli/kubacki.michal/SRF_CUTandTAG/iterative_alternative/results_2_new_001/peaks/narrow/${sample}_narrow_peaks.narrowPeak" \
...
python -u ../scripts/analyze_enrichment_NSC_5.py \
    ...
    2>&1 | tee "logs/enrichment_NSC_5_new_001.out"
