#!/bin/bash
#SBATCH --job-name=2_heatmaps_only_cpgs2_opt
...
#SBATCH --error="logs/2_heatmaps_only_cpgs_opt.err"
#SBATCH --output="logs/2_heatmaps_only_cpgs_opt.out"
...
log_info "Executing: Rscript 2_heatmaps_only_cpgs_opt.R"
if Rscript 2_heatmaps_only_cpgs_opt.R; then
    END_TIME=$(date +%s)
