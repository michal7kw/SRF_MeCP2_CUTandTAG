#!/bin/bash
#SBATCH --job-name=2_heatmaps_only_cpgs2
...
#SBATCH --error="logs/2_heatmaps_only_cpgs.err"
#SBATCH --output="logs/2_heatmaps_only_cpgs.out"
...
log_info "Executing: Rscript 2_heatmaps_only_cpgs.R"
if Rscript 2_heatmaps_only_cpgs.R; then
    END_TIME=$(date +%s)
