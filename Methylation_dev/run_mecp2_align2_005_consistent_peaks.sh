...
print_usage() {
    ...
    echo "Options:"
    echo "  --experiment VALUE     Specify experiment name (e.g., align2_005_consistent_peaks)"
...
SAMPLE_SIZE=100
EXPERIMENT="align2_005_consistent_peaks"  # Default value
...
# Define cell types and chromosomes
CELL_TYPES=("NEU" "NSC")
...
if [ $SLURM_ARRAY_TASK_ID -eq $((${#CELL_TYPES[@]} * ${#CHROMOSOMES[@]} - 1)) ]; then
