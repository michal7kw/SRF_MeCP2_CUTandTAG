...
python -u ../scripts/analyze_enrichment_NSC.py --working-dir /beegfs/scratch/ric.broccoli/kubacki.michal/SRF_CUTandTAG/snake_pipeline 2>&1 | tee "logs/analyze_enrichment_NSC.out"