...
class CpGAnalyzer:
    ...
    def calculate_enrichment_chunk(self, 
        ...
        """Calculate enrichment comparing Neuron vs NSC samples using peak-defined regions"""
...
def main():
    parser = argparse.ArgumentParser(description='Compare CpG enrichment between Neuron and NSC samples')
