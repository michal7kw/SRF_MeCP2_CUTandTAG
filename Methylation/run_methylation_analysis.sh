...
#SBATCH --error="logs/methylation_analysis.err"
#SBATCH --output="logs/methylation_analysis.out"
...
required_files=(
    ...
    "../iterative_alternative/DATA/DEA_NEU_filtered.csv"
    "../iterative_alternative/DATA/DEA_NSC_filtered.csv"
)
...
LOG_FILE="logs/methylation_analysis_$(date +%Y%m%d_%H%M%S).log"

python3 intersection.py 2>&1 | tee "$LOG_FILE"
